...
<section>
  ...
  <article>
        <div class="container" role="main">
            <div class="logo-wrap">
                <h1 class="logo_txt">FOOD</h1>
            </div>
            <div class="form_wrap">
                <form name="form" id="form" role="form" method="post"
                    action="foodInsertAction.deco" enctype="multipart/form-data">  <%-- ${pageContext.request.contextPath}/board/saveBoard --%>
                    ...
                    <div class="form-control-wrap">
                        <label for="menu1">메뉴*</label>
                            <div class="menu_container">
                                <div class="menu_123">
                                    <div class="menu_el">
                                        메뉴1<input type="text" class="form-control" name="menu1" id="menu1" placeholder="ex) 햄버거">
                                    </div>
                                    <div class="menu_el">
                                        가격1<input type="text" class="form-control" name="price1" id="price1" placeholder="ex) 5,000">원
                                    </div>
                                </div>
                                <div class="menu_123">
                                    <div class="menu_el">
