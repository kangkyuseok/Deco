...
<section>
  ...
  <div>
     		<!-- 파라미터 남아있게 하는게 숙제.... -->
    <form action="etcList.deco" method="get">
  ...
  <c:set var="pno" value="${pageDto.currentPage}"/>
    ...
    <ul>
    	<li> <a href ="etc.deco?eidx=${vo.eidx}&page=${pno}">${vo.name }</a></li>
    	<li>${vo.location }</li>
       <li>${vo.content }</li>
       <li>${vo.grade }</li>
       <li>${vo.menu }</li>
       <li> <img alt="cafe-out" src="/eimage/${vo.outimage}" width="200px" height="200px"></li>
