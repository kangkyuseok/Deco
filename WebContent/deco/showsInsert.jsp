...
<head>
<meta charset="UTF-8">
<title>::deco::공연 등록</title>
</head>
<body>
<%@ include file="../top.jsp" %>
<section>
		<h3>공연 추천지 등록</h3>
		<form  method="post" action="showsInsertAction.deco" enctype="multipart/form-data" >
		<table>
		<tr>
					<td><label>공연 이름</label></td>
					<!--  required 필수 입력  , readonly : 읽기만.-->
					<td><input type="text" name="name" placeholder="공연 이름(필수)"
						required></td>
				</tr>
				<tr>
					<td><label>공연 주소</label></td>
					<td><input type="text" name="addr" placeholder="공연 입력"></td>
				</tr>
				<tr> 
				 <td> <label>공연 지역명</label> </td>
				 <td> <input type ="text" name="location"></td>
				</tr>
				<tr>
					<td><label>공연 메뉴(표,가격)</label></td>
					<td><textarea rows="5" cols="50" placeholder ="메뉴(표,가격)를 작성해주세요"
 					class="input" name="menu"required></textarea></td>
				</tr>
				<tr> 
					<td><label>공연 평점</label> </td>
					<td> <input type ="number" name="grade" min ="1" max="5"> </td>
				
				</tr>
				<tr>
					<td><label>공연 문의번호</label></td>
					<td><input type="text" name="phone" placeholder="전화번호 입력"></td>
				</tr>
				<tr>
					<td><label>공연 OPEN 시간</label></td>
					<td><input type="time" name="opentime" placeholder="영업시간 입력"></td>
				</tr>
				<tr>
					<td><label>공연 CLOSE 시간</label></td>
					<td><input type="time" name="closetime" placeholder="영업시간 입력"></td>
				</tr>
				<tr>
					<td><label>공연 설명</label></td>
				...
				<tr>
					<td><label>공연 사이트</label></td>
					<td><input type="text" name="link" placeholder="공연사이트 입력"></td>
				</tr>
				<tr> 
				<td> 
					<input type="submit" value="저장" class="">
					<input type="reset" value="다시쓰기" class="">
					<input type="button" value="목록" onclick="location.href='showsList.deco'">
				 </td>
				</tr>
