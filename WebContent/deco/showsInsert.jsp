        ...
        <div class="container" role="main">
            ...
            <div class="form_wrap">
                <form name="form" id="form" role="form" method="post"
                    action="showsInsertAction.deco" enctype="multipart/form-data">  <%-- ${pageContext.request.contextPath}/board/saveBoard --%>
                    ...
                    <div class="form-control-wrap">
                        <label for="menu1">메뉴*</label>
                            <div class="menu_container">
                                <div class="menu_123">
                                    <div class="menu_el">
                                        메뉴1<input type="text" class="form-control" name="menu1" id="menu1" placeholder="ex) R석">
                                    </div>
                                    <div class="menu_el">
                                        가격1<input type="text" class="form-control" name="price1" id="price1" placeholder="ex) 18,000">원
                                    </div>
                                </div>
                                <div class="menu_123">
                                    <div class="menu_el">
                    ...
                    <div class="form-control-wrap">
                        <label for="phone">사이트바로가기*</label>
                        <input type="text" class="form-control" name="link" id="link" placeholder="www.naver.com">
                    </div>
                    <div class="form-btn">
