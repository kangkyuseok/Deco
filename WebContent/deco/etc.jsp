...
<form type="hidden" action="etcUpdate.deco?page=${page}"method="post">
<input type="hidden" value="${etc.eidx}" name="eidx">
 <ul class="detailContents">
      <li class="detailTitle">
        <div class="detailName">${etc.name}</div>
        <div class="detailText">${etc.content}</div>
      </li>
      <li class="detailImg">
        <div class="outImg">
      ...
      <li class="detailMenu">
        ...
        <ul class="menu"> <!--여기는 반복문으로 작성-->
          <li class="detailText">${etc.menu}</li>
         
        </ul>
      </li>
      <li class="detailTime">
        <div class="detailName">운영 시간</div>
        <div class="detailText">${etc.opentime} ~ ${etc.closetime}</div>
      </li>
      <li class="detailPhone">
        <div class="detailName">연락처</div>
        <div class="detailText">${etc.phone}</div>
      </li>
      <li class="detailAddr">
        <div class="detailName">위치정보</div>
        <div class="detailText">${etc.addr}</div>
      </li>
...
<div>
   ...
   <input type="button" onclick="location.href='etcList.deco?page=${page}'" value="리스트" class="button small">
</div>
</form>
  <section>
 <form action="etcDibsUpdate.deco">
    <input type="hidden" name="idx" value="${etc.eidx }">
        ...
        <div class="reviewContents">
          <ul class="reviewNameGrade">
            ...
            <li>
              <span>평점 : </span>
              <span>${re.grade}</span>
<a href="javascript:deleteCmt('${re.idx}','${etc.eidx}','${re.grade}','${page}','${re.nickname}')">삭제</a>
            </li>
          </ul>
